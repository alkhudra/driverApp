...
Drawer drawerDesignWithInfo(context,image,name,email) {
      ...
      children: [
          ...
          child: Column(
            children: [
              Container(
                ...
                margin: EdgeInsets.only(top: 40),
                child: CircleAvatar(
                  backgroundImage: NetworkImage(ApiConst.dashboard_url + image),
                ),
              ),
              SizedBox(height: 20,),
              Container(
        ...
        ListTile(
          ...
          onTap: () {
            ...
            PreferencesHelper.setUserLoggedIn(false).then((value) => PreferencesHelper.setUser(null).then((value) =>  moveToNewStack(context, loginRoute)));
            //PreferencesHelper.setUserFirstLogIn(false);
