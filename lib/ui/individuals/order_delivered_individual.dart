...
class OrderDeliveredIndividual extends StatefulWidget {
  final OrderHeaderIndividual model;
  const OrderDeliveredIndividual({Key? key,required this.model}) : super(key: key);

  @override
  State<OrderDeliveredIndividual> createState() => _OrderDeliveredIndividualState();
}

class _OrderDeliveredIndividualState extends State<OrderDeliveredIndividual> {


  @override
  Widget build(BuildContext context) {
    bool hasPaid = widget.model.hasPaid!;
    ...
    OrderHeaderIndividual? orderModel = widget.model;
              ...
              children: [
                ...
                Container(
                  ...
                  child: greenBtn(LocaleKeys.confirm_Delivery.tr(), EdgeInsets.symmetric(horizontal: 60), () async {
                    ...
                    await orderRepository.orderIndividualDelivered(orderModel.invoiceNumber!, hasPaid);
